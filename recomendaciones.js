document.addEventListener("DOMContentLoaded", () => {
  // Menú hamburguesa: alterna la clase "show" para desplegar el menú en móviles
  ...
  // Variable para simular si el usuario es administrador (cambia a false para pruebas)
  const isAdmin = true;
  if (!isAdmin) {
  ...
  userForm.addEventListener("submit", (e) => {
    ...
    // Contenido HTML de la recomendación
    let html = `
